...
| Two-servo ramp | Not present | Closed/open ramp UI and API through direct GPIO12/GPIO18 servo signals | Both servos initialize closed at logical 0 degrees and open to 100 degrees; GPIO18 is mirrored in software. |
