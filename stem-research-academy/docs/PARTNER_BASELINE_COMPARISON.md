...
| Two-servo ramp | Not present | Closed/open ramp UI and API through direct GPIO12/GPIO18 servo signals | Both servos initialize closed at logical 0 degrees and open to 120 degrees; GPIO18 is mirrored in software. |
...
The isolated target desktop suite currently passes **64 tests**, and the
...
Three current 1,000-cycle mocked composite runs averaged **1.788-2.003 ms**
locally, with **2.754-3.197 ms** p95 and a **14.001 ms** worst observed maximum
on the Windows validation host. This is consistent with
