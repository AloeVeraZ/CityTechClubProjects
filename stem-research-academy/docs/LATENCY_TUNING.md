...
update, snapshot, camera detection update, or vision result.
...
1. Start with YOLO off and perform a raised-wheel 3TSahur test.
2. Confirm the automatically detected USB camera mode, then scroll to LARP A
   and LARP B and repeat each scout separately.
